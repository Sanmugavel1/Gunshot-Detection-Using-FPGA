...
HD_PWD='C:/Users/sanmugavel/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gunshot_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_gunshot_system.tcl
