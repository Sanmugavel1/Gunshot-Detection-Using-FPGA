...
HD_PWD='C:/Users/sanmugavel/project_7/project_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gunshot_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_gunshot_system.tcl -notrace
